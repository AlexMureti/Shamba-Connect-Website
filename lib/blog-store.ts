...
const defaultPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "A comprehensive guide to setting up your first urban kitchen garden. Learn about site selection, soil preparation, and choosing the right vegetables for Nairobi's climate.",
...
With patience and consistent care, your kitchen garden will provide fresh, nutritious vegetables for your family. Start small, learn as you grow, and enjoy the journey!`,
    ...
    author: "Mercy Munene",
    date: "Jan 15, 2024",
    featuredImage: "/media/shamba-31.webp",
  ...
  },
  {
    ...
    excerpt:
      "Discover which vegetables grow best in Nairobi's unique climate. Tips on planting seasons and care requirements for optimal yields year-round.",
    content: `## Introduction
...
Fast-growing and nutrient-packed, spinach thrives in Nairobi's cooler nights. Succession plant every 2 weeks for continuous harvests.`,
    ...
    date: "Jan 10, 2024",
    featuredImage: "/media/shamba-38.webp",
  ...
  },
  {
    ...
    excerpt:
      "Complete beginner's guide to rabbit farming. Learn about housing, feeding, breeding, and health management for successful and profitable rabbit farming.",
...
Rabbit meat is lean, healthy, and in growing demand. Establish relationships with hotels, restaurants, and health-conscious consumers.`,
    ...
    author: "Mercy Munene",
    date: "Jan 5, 2024",
    featuredImage: "/media/shamba-15.webp",
  ...
  },
  {
    ...
    excerpt:
      "Say no to chemicals with these effective organic pest control methods. Protect your vegetables naturally while keeping your family and environment safe.",
...
Organic pest control requires observation and patience, but it creates a healthier garden ecosystem that naturally resists pest outbreaks.`,
    ...
    author: "Agricultural Team",
    date: "Dec 28, 2023",
    featuredImage: "/media/shamba-39.webp",
  ...
  },
  {
    ...
    excerpt:
      "Meet the Wanjiru family who transformed their backyard into a productive garden. Read about their journey and the impact on their food security and health.",
...
The Wanjiru family's success is not unique. With commitment and the right support, you too can transform your space into a productive food source.`,
    ...
    author: "Mercy Munene",
    date: "Dec 20, 2023",
    featuredImage: "/media/shamba-48.webp",
  ...
  },
  {
    ...
    excerpt:
      "Learn how to create nutrient-rich compost from kitchen and garden waste. Simple steps to sustainable soil management and reduce your household waste.",
    content: `## Why Compost?
...
**Not decomposing**: Too dry or too much brown material. Add greens and water.`,
    ...
    author: "Agricultural Team",
    date: "Dec 15, 2023",
    featuredImage: "/media/shamba-46.webp",
...
You don't need a large farm to be a farmer. Whether it's a balcony, a small backyard, or a rooftop, Shamba Connect can help you start your journey to food independence.`,
    ...
    author: "Mercy Munene",
    date: "May 24, 2024",
    featuredImage: "/media/shamba-06.webp",
...
export const useBlogStore = create<BlogStore>((set, get) => ({
  ...
  updatePost: (id, updates) => {
    set((state) => {
      const newPosts = state.posts.map((post) => (post.id === id ? { ...post, ...updates } : post))
      if (typeof window !== "undefined") {
        localStorage.setItem("shambaConnectBlogPosts", JSON.stringify(newPosts))
      }
      return { posts: newPosts }
  ...
  incrementViews: (slug) => {
    set((state) => {
      const newPosts = state.posts.map((post) => (post.slug === slug ? { ...post, views: post.views + 1 } : post))
      if (typeof window !== "undefined") {
        localStorage.setItem("shambaConnectBlogPosts", JSON.stringify(newPosts))
      }
      return { posts: newPosts }
...
export function saveBlogPost(post: Omit<BlogPost, "id" | "views">): BlogPost {
