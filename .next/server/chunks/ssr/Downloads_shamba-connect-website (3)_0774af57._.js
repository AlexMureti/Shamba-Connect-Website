...
**Not decomposing**: Too dry or too much brown material. Add greens and water.`,category:"Organic Practices",author:"Agricultural Team",date:"Dec 15, 2023",featuredImage:"/compost-bin-with-organic-matter-and-rich-dark-comp.jpg",slug:"composting-made-easy",published:!0,views:201,readTime:"5 min read"}],g=(b=(a,b)=>({posts:f,addPost:b=>{let c={...b,id:Date.now().toString(),views:0};a(a=>({posts:[c,...a.posts]}))},updatePost:(b,c)=>{a(a=>({posts:a.posts.map(a=>a.id===b?{...a,...c}:a)}))},deletePost:b=>{a(a=>({posts:a.posts.filter(a=>a.id!==b)}))},getPostBySlug:a=>b().posts.find(b=>b.slug===a),incrementViews:b=>{a(a=>({posts:a.posts.map(a=>a.slug===b?{...a,views:a.views+1}:a)}))}}))?e(b):e;function h(a){return a.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function i(a){return g.getState().addPost(a),g.getState().posts[0]}function j(a,b){g.getState().updatePost(a,b)}a.s(["generateSlug",()=>h,"saveBlogPost",()=>i,"updateBlogPost",()=>j,"useBlogStore",0,g],93833)},48056,a=>{"use strict";let b=(0,a.i(31381).default)("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);a.s(["Calendar",()=>b],48056)},95726,a=>{"use strict";let b=(0,a.i(31381).default)("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);a.s(["ArrowRight",()=>b],95726)},87833,a=>{"use strict";let b=(0,a.i(31381).default)("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);a.s(["User",()=>b],87833)},68866,a=>{"use strict";var b=a.i(80537),c=a.i(37289),d=a.i(19217);function e(){let[a,e]=(0,d.useState)("all");return(0,b.jsx)("section",{className:"py-8 bg-card border-y border-border sticky top-20 z-40",children:(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,b.jsx)("div",{className:"flex flex-wrap gap-3 justify-center",children:[{id:"all",label:"All Posts"},{id:"kitchen-gardens",label:"Kitchen Gardens"},{id:"rabbit-farming",label:"Rabbit Farming"},{id:"organic-practices",label:"Organic Practices"},{id:"success-stories",label:"Success Stories"}].map(d=>(0,b.jsx)(c.Button,{variant:a===d.id?"default":"outline",onClick:()=>e(d.id),children:d.label},d.id))})})})}a.s(["BlogCategories",()=>e])},6280,a=>{"use strict";var b=a.i(80537),c=a.i(19217),d=a.i(42667),e=a.i(37289),f=a.i(48056),g=a.i(87833),h=a.i(95726),i=a.i(84796),j=a.i(93833);function k(){let a=(0,j.useBlogStore)(a=>a.posts),[k,l]=(0,c.useState)(!1),m=(0,c.useMemo)(()=>a.filter(a=>a.published),[a]);return((0,c.useEffect)(()=>{l(!0)},[]),k)?(0,b.jsx)("section",{className:"py-20 bg-background",children:(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:0===m.length?(0,b.jsx)("div",{className:"text-center py-16",children:(0,b.jsx)("p",{className:"text-muted-foreground text-lg",children:"No blog posts published yet."})}):(0,b.jsx)("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:m.map(a=>(0,b.jsxs)(d.Card,{className:"overflow-hidden hover:shadow-lg transition-shadow flex flex-col",children:[(0,b.jsx)("img",{src:a.featuredImage||"/placeholder.svg",alt:a.title,className:"w-full h-48 object-cover"}),(0,b.jsxs)(d.CardHeader,{className:"flex-grow",children:[(0,b.jsx)("div",{className:"flex items-center gap-2 text-sm text-muted-foreground mb-2",children:(0,b.jsx)("span",{className:"text-primary font-medium",children:a.category})}),(0,b.jsx)(d.CardTitle,{className:"text-xl",children:a.title}),(0,b.jsx)(d.CardDescription,{className:"line-clamp-3",children:a.excerpt})]}),(0,b.jsxs)(d.CardFooter,{className:"flex-col items-start gap-4",children:[(0,b.jsxs)("div",{className:"flex items-center gap-4 text-sm text-muted-foreground w-full",children:[(0,b.jsxs)("div",{className:"flex items-center gap-1",children:[(0,b.jsx)(g.User,{size:14}),(0,b.jsx)("span",{children:a.author})]}),(0,b.jsxs)("div",{className:"flex items-center gap-1",children:[(0,b.jsx)(f.Calendar,{size:14}),(0,b.jsx)("span",{children:a.date})]})]}),(0,b.jsx)(e.Button,{asChild:!0,variant:"ghost",className:"group -ml-4",children:(0,b.jsxs)(i.default,{href:`/blog/${a.slug}`,children:["Read Article",(0,b.jsx)(h.ArrowRight,{className:"ml-2 group-hover:translate-x-1 transition-transform",size:16})]})})]})]},a.id))})})}):(0,b.jsx)("div",{className:"py-20 bg-background"})}a.s(["BlogGrid",()=>k])}];

//# sourceMappingURL=Downloads_shamba-connect-website%20%283%29_0774af57._.js.map