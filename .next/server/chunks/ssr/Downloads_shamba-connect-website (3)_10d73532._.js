...
**Not decomposing**: Too dry or too much brown material. Add greens and water.`,category:"Organic Practices",author:"Agricultural Team",date:"Dec 15, 2023",featuredImage:"/compost-bin-with-organic-matter-and-rich-dark-comp.jpg",slug:"composting-made-easy",published:!0,views:201,readTime:"5 min read"}],g=(b=(a,b)=>({posts:f,addPost:b=>{let c={...b,id:Date.now().toString(),views:0};a(a=>({posts:[c,...a.posts]}))},updatePost:(b,c)=>{a(a=>({posts:a.posts.map(a=>a.id===b?{...a,...c}:a)}))},deletePost:b=>{a(a=>({posts:a.posts.filter(a=>a.id!==b)}))},getPostBySlug:a=>b().posts.find(b=>b.slug===a),incrementViews:b=>{a(a=>({posts:a.posts.map(a=>a.slug===b?{...a,views:a.views+1}:a)}))}}))?e(b):e;function h(a){return a.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function i(a){return g.getState().addPost(a),g.getState().posts[0]}function j(a,b){g.getState().updatePost(a,b)}a.s(["generateSlug",()=>h,"saveBlogPost",()=>i,"updateBlogPost",()=>j,"useBlogStore",0,g],93833)},98333,a=>{"use strict";var b=a.i(80537),c=a.i(42667),d=a.i(37289),e=a.i(31381);let f=(0,e.default)("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]),g=(0,e.default)("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);var h=a.i(4827),i=a.i(84796),j=a.i(93833);function k(){let a=(0,j.useBlogStore)(a=>a.posts),e=(0,j.useBlogStore)(a=>a.deletePost);return(0,b.jsx)("div",{className:"min-h-screen bg-background py-20",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[(0,b.jsxs)("div",{className:"flex justify-between items-center mb-8",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-foreground mb-2",children:"Blog Management"}),(0,b.jsx)("p",{className:"text-muted-foreground",children:"Create and manage your blog posts"})]}),(0,b.jsx)(d.Button,{asChild:!0,size:"lg",className:"bg-primary hover:bg-primary/90",children:(0,b.jsxs)(i.default,{href:"/admin/blog/new",children:[(0,b.jsx)(f,{className:"mr-2",size:20}),"New Post"]})})]}),(0,b.jsxs)(c.Card,{children:[(0,b.jsxs)(c.CardHeader,{children:[(0,b.jsxs)(c.CardTitle,{children:["All Posts (",a.length,")"]}),(0,b.jsx)(c.CardDescription,{children:"Manage your published and draft blog posts"})]}),(0,b.jsx)(c.CardContent,{children:0===a.length?(0,b.jsx)("div",{className:"text-center py-8 text-muted-foreground",children:(0,b.jsx)("p",{children:"No blog posts yet. Create your first post!"})}):(0,b.jsx)("div",{className:"space-y-4",children:a.map(a=>(0,b.jsxs)("div",{className:"flex items-center justify-between p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors",children:[(0,b.jsxs)("div",{className:"flex-1",children:[(0,b.jsx)("h3",{className:"font-semibold text-foreground mb-1",children:a.title}),(0,b.jsxs)("div",{className:"flex items-center gap-4 text-sm text-muted-foreground",children:[(0,b.jsxs)("span",{className:"flex items-center gap-1",children:[(0,b.jsx)(h.Eye,{size:14}),a.views," views"]}),(0,b.jsx)("span",{children:a.date}),(0,b.jsx)("span",{className:`px-2 py-1 rounded-full text-xs ${a.published?"bg-green-500/10 text-green-600":"bg-yellow-500/10 text-yellow-600"}`,children:a.published?"published":"draft"})]})]}),(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(d.Button,{variant:"outline",size:"sm",asChild:!0,children:(0,b.jsxs)(i.default,{href:`/blog/${a.slug}`,children:[(0,b.jsx)(h.Eye,{size:16,className:"mr-1"}),"View"]})}),(0,b.jsx)(d.Button,{variant:"outline",size:"sm",className:"text-destructive bg-transparent",onClick:()=>{var b;return b=a.id,void(confirm("Are you sure you want to delete this blog post?")&&e(b))},children:(0,b.jsx)(g,{size:16})})]})]},a.id))})})]})]})})}a.s(["default",()=>k],98333)}];

//# sourceMappingURL=Downloads_shamba-connect-website%20%283%29_10d73532._.js.map